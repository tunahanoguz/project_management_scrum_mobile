...
class ProjectSendChildComment extends Component {
    constructor(props) {
        super(props);
    ...
    sendComment = () => {
        ...
        const parentComment = this.props.navigation.getParam('parentComment', {});
        this.props.sendProjectParentComment(projectID, this.props.user.uid, this.state.comment, parentComment.id);
    ...
    render() {
        return (
            <Container>
                ...
                <InnerContainer>
                    <Text style={fonts.title}>Cevapla</Text>
                    <ChildCommentCard comment={} />
...
export default connect(mapStateToProps, mapDispatchToProps)(ProjectSendChildComment);